...
了解上述分步工作流、对白语速物理公式、长台词多景别切分、物理视觉化描述铁律以及格式要求后，请严格执行第一步。""",
  ...
  "phase_3_定帧生图公式（中英混合，绝对锁定原版光影）": {
    "结构": "[画面主体与场景环境(中文)] + [定格物理动作/姿态(中文)] + [定格微表情(中文)] + [当前景别与具体机位角度(如低角度仰拍/过肩/俯拍，中文)] + [全局摄影参数及调性(直接照抄分镜表中的英文)] + [光线(直接照抄分镜表中的英文)] + [动态人物肤质后缀(中文)]",
    "定格动作约束": "严禁使用 ongoing 动态词（如 ❌ '奔跑着'，改为 ✅ '单脚腾空跨步的悬停瞬间'；❌ '挥刀砍去'，改为 ✅ '双手举刀过顶的定格瞬间'）。",
    "机位角度约束": "必须明确当前画面的摄影机物理角度，如：平视机位、低角度仰拍、高角度俯拍、倾斜构图等，确保生图视角明确。",
    "动态人物质感后缀": "画面中若有出场人物，必须加皮肤词：默认使用'粗糙皮肤，1:1真实肤色，可见细纹，可见毛孔，细微绒毛'。但【红线注意】：若角色为年轻女性或小孩，必须智能剔除'粗糙皮肤'与'细纹'，保留真实毛孔与肤色即可。"
  },
